...
async def cmd_start(message: Message):
    ...
    await message.answer(
        f"👋 Привет, {user_name}!\n\n"
        f"Я универсальный ИИ-ассистент по работе с документами и графикой на базе `{gemini_service.model}`.\n\n"
        f"💡 **Что я умею:**\n"
        f"• **Схемы родства и деревья**: «нарисуй генеалогическое древо / схему родства» — создам профессиональную графическую диаграмму.\n"
        f"• **Графики и диаграммы**: «построй график выручки» или «сделай круговую диаграмму».\n"
        f"• **Документы Word (.docx)**: договоры, заявления, иски со встроенными таблицами и схемами.\n"
        f"• **Таблицы Excel (.xlsx)**: расчеты, сметы, финансовые отчеты.\n"
        f"• **PDF-отчеты и презентации**: многостраничные отчеты и слайды.\n"
        f"• **Чтение любых файлов**: отправьте мне PDF, DOCX, TXT, фото или скан — я проанализирую их и отвечу на вопросы!\n\n"
        f"📌 **Команды:**\n"
